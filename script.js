...
document.addEventListener('DOMContentLoaded', () => {
    ...
    const etfData = {
        ...
        'FBTC': { name: 'Fidelity Advantage Bitcoin ETF', provider: 'Fidelity', url: 'https://www.fidelity.ca/en/products/etfs/fbtc', mer: 0.44, asset: 'Bitcoin', structure: 'Spot Physical', currency: 'CAD', custodian: 'Fidelity Clearing Canada ULC', aum: '[AUM]', yield: 'N/A', perf1Y: "[Perf%]", perf3Y: "[Perf%]", perf5Y: "N/A", topHoldings: ['Bitcoin'], sectors: {'Crypto': 100} }, // Custodian updated based on Fidelity docs
        ...
        'ETHH': { name: 'Purpose Ether ETF CAD Non-Hedged', provider: 'Purpose', url: 'https://www.purposeinvest.com/funds/purpose-ether-etf', mer: 1.00, asset: 'Ethereum', structure: 'Spot Physical', currency: 'CAD', custodian: 'Gemini', aum: '$254M', yield: 'N/A', perf1Y: "[Perf%]", perf3Y: "[Perf%]", perf5Y: "N/A", topHoldings: ['Ether'], sectors: {'Crypto': 100} }, // MER likely capped at 1.50%, reported 1.00% used.
        'ETHR': { name: 'Evolve Ether ETF', provider: 'Evolve', url: 'https://evolveetfs.com/product/ethr/', mer: 0.75, asset: 'Ethereum', structure: 'Spot Physical', currency: 'CAD', custodian: 'Gemini', aum: '[AUM]', yield: 'N/A', perf1Y: "[Perf%]", perf3Y: "[Perf%]", perf5Y: "N/A", topHoldings: ['Ether'], sectors: {'Crypto': 100} }, // Sub-custodian Gemini
        'ETHX.B': { name: 'CI Galaxy Ethereum ETF (CAD Unhedged)', provider: 'CI Galaxy', url: 'https://ci.com/en/financial P/galaxy-ethereum-etf-ethx-b-NEO', mer: 0.40, asset: 'Ethereum', structure: 'Spot Physical', currency: 'CAD', custodian: 'Gemini', aum: '[AUM]', yield: 'N/A', perf1Y: "[Perf%]", perf3Y: "[Perf%]", perf5Y: "N/A", topHoldings: ['Ether'], sectors: {'Crypto': 100} }, // Custodian assumed Gemini like BTCX
        ...
        'HCAL': { name: 'Hamilton Enhanced Canadian Bank ETF', provider: 'Hamilton', url: 'https://horizonsetfs.com/ETF/hcal/', mer: 0.65, asset: 'Equity', index: 'Solactive Equal Weight Canada Banks (1.25x)', sectorFocus: 'Financials', geoFocus: 'Canada', aum: '$534M', yield: '6.16%', summary: 'Equal weighted Big 6 Cdn Banks with 1.25x leverage. Higher risk/reward.', perf1Y: "[Perf%]", perf3Y: "[Perf%]", perf5Y: "N/A", topHoldings: ['Royal Bank', 'TD Bank', 'Scotiabank', 'BMO', 'CIBC', 'National Bank'], sectors: {'Financials': 100} }, // Note MER may not include leverage cost fully.
        // Energy - Add data
        ...
        // Technology - Add data
        'XIT': { name: 'iShares S&P/TSX Capped Information Technology Index ETF', provider: 'iShares', url: 'https://www.blackrock.com/ca/investors/en/products/239841/', mer: 0.61, asset: 'Equity', index: 'S&P/TSX Capped Info Tech', sectorFocus: 'Technology', geoFocus: 'Canada', aum: '[AUM]', yield: '[Yield]%', summary: 'Market cap weighted Cdn Tech (Highly concentrated).', perf1Y: "[Perf%]", perf3Y: "[Perf%]", perf5Y: "[Perf%]", topHoldings: [], sectors: {'Information Technology': 100} },
        'TEC': { name: 'BMO MSCI Tech Innovation Index ETF', provider: 'BMO', url: 'https://www.bmogam.com/ca/en/advisors/investment-solutions/etf/bmo-msci-tech-innovation-index-etf-tec/', mer: 0.39, asset: 'Equity', index: 'MSCI ACWI IMI Innovation', sectorFocus: 'Technology', geoFocus: 'Global', aum: '[AUM]', yield: '[Yield]%', summary: 'Global Tech Innovation (US heavy).', perf1Y: "[Perf%]", perf3Y: "[Perf%]", perf5Y: "[Perf%]", topHoldings: [], sectors: {'Information Technology': '~80', 'Communication Services': '~10', 'Consumer Discretionary': '~10'} },
        'ZNQ': { name: 'BMO NASDAQ 100 Equity Index ETF', provider: 'BMO', url: 'https://www.bmogam.com/ca/en/advisors/investment-solutions/etf/bmo-nasdaq-100-equity-index-etf-znq/', mer: 0.39, asset: 'Equity', index: 'Nasdaq 100', sectorFocus: 'Technology', geoFocus: 'US', aum: '[AUM]', yield: '[Yield]%', summary: 'Tracks Nasdaq 100 (US Tech/Growth).', perf1Y: "[Perf%]", perf3Y: "[Perf%]", perf5Y: "[Perf%]", topHoldings: [], sectors: {'Information Technology': 50.0, 'Communication Services': 15.0, 'Consumer Discretionary': 14.0} },
        ...
        'COM': { name: 'Purpose Diversified Real Asset ETF', provider: 'Purpose', url: 'https://www.purposeinvest.com/funds/purpose-diversified-real-asset-fund', mer: 0.73, asset: 'Diversified Real Assets', structure: 'Multi-Asset (Equities, Futures)', currency: 'CAD', custodian: 'N/A', aum: '[AUM]', yield: '[Yield]%', summary: 'Broad exposure including commodities, infra, real estate.', perf1Y: "[Perf%]", perf3Y: "[Perf%]", perf5Y: "[Perf%]", topHoldings: ['Various Equities & Futures'], sectors: {'Commodity': '~35', 'Real Estate': '~25', 'Infrastructure': '~20', 'Other': '~20'} }, // Example sector breakdown

         // --- Fixed Income ETFs --- // Added Duration & Quality where found
        ...
        'XBB': { name: 'iShares Core Canadian Universe Bond Index ETF', provider: 'iShares', url: 'https://www.blackrock.com/ca/individual/en/products/239494/', mer: 0.10, asset: 'Bond', index: 'FTSE Canada Universe Bond', duration: 7.4, avgQuality: 'AA-', aum: '$4.5B', yield: '4.0%', summary: 'Broad Canadian investment-grade bonds.', perf1Y: "[Perf%]", perf3Y: "[Perf%]", perf5Y: "[Perf%]", topHoldings: [], sectors: {'Government': '~60', 'Corporate': '~35', 'Other': '~5'} }, // Quality/Duration from ZAG vs VAB vs XBB article
        'ZAG': { name: 'BMO Aggregate Bond Index ETF', provider: 'BMO', url: 'https://www.bmogam.com/ca/en/advisors/investment-solutions/etf/bmo-aggregate-bond-index-etf-zag/', mer: 0.09, asset: 'Bond', index: 'FTSE Canada Universe Bond', duration: 7.5, avgQuality: 'AA-', aum: '$5.9B', yield: '3.5%', summary: 'Broad Canadian investment-grade bonds.', perf1Y: "[Perf%]", perf3Y: "[Perf%]", perf5Y: "[Perf%]", topHoldings: [], sectors: {'Government': '~60', 'Corporate': '~35', 'Other': '~5'} }, // Quality/Duration from ZAG vs VAB vs XBB article
        'VSB': { name: 'Vanguard Canadian Short-Term Bond Index ETF', provider: 'Vanguard', url: 'https://www.vanguard.ca/en/advisor/products/products-group/etfs/VSB', mer: 0.11, asset: 'Bond', index: 'Bloomberg GA CAD Float Adj 1-5 Yr', duration: '[Dur]', avgQuality: '[Qual]', aum: '[AUM]', yield: '[Yield]%', summary: 'Short-term (1-5 yr) Canadian investment-grade bonds.', perf1Y: "[Perf%]", perf3Y: "[Perf%]", perf5Y: "[Perf%]", topHoldings: [], sectors: {} },
        'XSB': { name: 'iShares Core Canadian Short Term Bond Index ETF', provider: 'iShares', url: 'https://www.blackrock.com/ca/investors/en/products/239496/', mer: 0.10, asset: 'Bond', index: 'FTSE Canada Short Term Bond', duration: '[Dur]', avgQuality: '[Qual]', aum: '[AUM]', yield: '[Yield]%', summary: 'Short-term Canadian investment-grade bonds.', perf1Y: "[Perf%]", perf3Y: "[Perf%]", perf5Y: "[Perf%]", topHoldings: [], sectors: {} },
        'ZSB': { name: 'BMO Short-Term Bond Index ETF', provider: 'BMO', url: 'https://www.bmogam.com/ca/en/advisors/investment-solutions/etf/bmo-short-term-bond-index-etf-zsb/', mer: 0.11, asset: 'Bond', index: 'FTSE Canada Short Term Overall Bond', duration: '[Dur]', avgQuality: '[Qual]', aum: '[AUM]', yield: '[Yield]%', summary: 'Short-term Canadian investment-grade bonds.', perf1Y: "[Perf%]", perf3Y: "[Perf%]", perf5Y: "[Perf%]", topHoldings: [], sectors: {} },
        ...
        'VGV': { name: 'Vanguard Canadian Government Bond Index ETF', provider: 'Vanguard', url: 'https://www.vanguard.ca/en/advisor/products/products-group/etfs/VGV', mer: 0.17, asset: 'Bond', index: 'Bloomberg GA CAD Float Adj Govt', duration: '[Dur]', avgQuality: 'AA+', aum: '$58M', yield: '[Yield]%', summary: 'Canadian government bonds (Federal/Provincial/Municipal).', perf1Y: "[Perf%]", perf3Y: "[Perf%]", perf5Y: "[Perf%]", topHoldings: [], sectors: {'Government': 100} }, // Low AUM noted in article
        ...
        'ZGB': { name: 'BMO Government Bond Index ETF', provider: 'BMO', url: 'https://www.bmogam.com/ca/en/advisors/investment-solutions/etf/bmo-government-bond-index-etf-zgb/', mer: '[MER]', asset: 'Bond', index: 'FTSE Canada All Government Bond', duration: '[Dur]', avgQuality: '[Qual]', aum: '[AUM]', yield: '[Yield]%', summary: 'Canadian government bonds (Federal/Provincial/Municipal).', perf1Y: "[Perf%]", perf3Y: "[Perf%]", perf5Y: "[Perf%]", topHoldings: [], sectors: {'Government': 100} },
    ...
    function displayComparison(tickers, comparisonOutputElement, type) {
        ...
        // Determine if comparison involves types needing Geo/Sector charts skipped
         let skipGeoSector = tickers.some(t => {
             ...
             return data?.asset === 'Bitcoin' ||
                    ...
                    (data?.sectors && Object.keys(data.sectors).length === 1 && (data.sectors['Crypto'] === 100 || data.sectors['Carbon Credits'] === 100 || data.sectors['Commodity'] === 100)); // Added Commodity single sector
         });
        ...
        tickers.forEach((ticker, index) => {
            ...
            if (data.topHoldings && Array.isArray(data.topHoldings)) {
                 const actualHoldings = data.topHoldings.filter(h => typeof h === 'string' && !h.startsWith('[') && h !== 'Swap Counterparty' && h !== 'Various Equities & Futures'); // Filter out placeholders and generic swap/multi-asset text
            ...
            const durationInfo = data.duration ? `<li><strong><span class="tooltip" data-tooltip="Measures sensitivity to interest rate changes (higher = more sensitive).">Duration</span>:</strong> <span>${data.duration} yrs</span></li>` : '';
        ...
        if (!dataFound) {
         ...
         const colorMap = {
          ...
          const sortedSectorCategories = Array.from(sectorCategories).sort((a, b) => {
             const order = { 'Energy': 1, 'Materials': 2, 'Industrials': 3, 'Consumer Discretionary': 4, 'Consumer Staples': 5, 'Health Care': 6, 'Financials': 7, 'Information Technology': 8, 'Communication Services': 9, 'Utilities': 10, 'Real Estate': 11, 'Fixed Income': 12, 'Government': 13, 'Corporate': 14, 'Commodity': 15, 'Crypto': 16, 'Carbon Credits': 17, 'Other': 99 };
             return (order[a] || 50) - (order[b] || 50);
          });
